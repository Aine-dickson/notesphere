            ...
            <nav class="flex" aria-label="Breadcrumb">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <div class="flex items-center">
                        /
                        <span class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">My Channels</span>
                    </div>
                    </li>
                    <li aria-current="page">
                        /
                        <span class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">channel 44</span>
                    </li>
                </ol>
            </nav>
